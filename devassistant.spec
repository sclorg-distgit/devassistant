...
Patch1:         %{pkg_name}-0.9.0-dont-install-gui.patch
...
* Thu May 29 2014 Bohuslav Kabrda <bkabrda@redhat.com> - 0.9.0-2
- Make paths alteration patch apply cleanly.

* Tue May 27 2014 Bohuslav Kabrda <bkabrda@redhat.com> - 0.9.0-1
- Update to 0.9.0 final

* Mon May 26 2014 Bohuslav Kabrda <bkabrda@redhat.com> - 0.9.0-0.4.b1
- Fix setting up project dirs by dedicated command runner.

* Thu May 22 2014 Bohuslav Kabrda <bkabrda@redhat.com> - 0.9.0-0.3.b1
- Depend on argparse and PyYAML from this SCL
- Don't include manpage for GUI, we don't ship it on RHEL 6
